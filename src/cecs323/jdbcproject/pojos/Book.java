...
public class Book {
	 ...
	 * 
	 * Must be no more than 30 characters in length, and the name of an existing
	 * <code>WritingGroup</code>.
	 */
	 ...
	 * 
	 * Must be no more than 40 characters in length, and unique within the
	 * {@link WritingGroup} that wrote this Book.
	 * 
	 * @see #groupName
	 */
